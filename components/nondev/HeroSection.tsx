  ...
  return (
    <section id="about" className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-blue-100 px-6">
      ...
      >
        {/* X Close Button */}
        <button
          className="absolute top-6 right-6 p-2 rounded hover:bg-gray-100 transition text-blue-600"
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center py-12">
        ...
        <div className="space-y-8">
          ...
          <div id="abouts" className="mt-8 scroll-mt-24 space-y-4 text-gray-700 text-base leading-relaxed">
            <p>
              I&apos;m a backend developer focused on building fast, secure, and maintainable APIs. I actively integrate AI tools into my workflow to automate boring tasks and streamline development.
            </p>
            <p>
              I&apos;m passionate about optimizing workflows through automation and problem-solving.
            </p>
            <p>
              I care deeply about clean code, modular architecture, and delivering seamless user experiences.
            </p>
            <p>
              I&apos;m curious by nature, always learning something new, and I love finding smarter ways to solve problems. When I&apos;m not coding, you&apos;ll usually find me experimenting with side projects, playing chess, or drawing.
            </p>
          </div>
        </div>
